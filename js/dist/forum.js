...
var SearchGIFModal = /*#__PURE__*/function (_Modal) {
  Object(_babel_runtime_helpers_esm_inheritsLoose__WEBPACK_IMPORTED_MODULE_1__["default"])(SearchGIFModal, _Modal);
  ...
  _proto.content = function content() {
    ...
    return m('.Modal-body', {
              ...
              switch (_context2.prev = _context2.next) {
                ...
                case 25:
                  ...
                  div.addEventListener('click', function (e) {
                    document.getElementById('therealsujitk-gifs-search-input').getElementsByTagName('input')[0].value = e.target.innerText;
      ...
      onclick: function () {
        var _onclick = Object(_babel_runtime_helpers_esm_asyncToGenerator__WEBPACK_IMPORTED_MODULE_0__["default"])( /*#__PURE__*/_babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_2___default.a.mark(function _callee3() {
          var gifs;
          return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_2___default.a.wrap(function _callee3$(_context3) {
            while (1) {
              switch (_context3.prev = _context3.next) {
                case 0:
                  lastQuery = document.getElementById('therealsujitk-gifs-search-input').getElementsByTagName('input')[0].value.trim();
                  lastOffset = 0;
    ...
    }, app.translator.trans('therealsujitk.forum.gifs.search'))]), m('div', {
      id: 'therealsujitk-gifs-container',
      oncreate: function oncreate() {
        var container = document.getElementById('therealsujitk-gifs-container');
        container.addEventListener('scroll', /*#__PURE__*/Object(_babel_runtime_helpers_esm_asyncToGenerator__WEBPACK_IMPORTED_MODULE_0__["default"])( /*#__PURE__*/_babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_2___default.a.mark(function _callee5() {
          var gifs;
          return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_2___default.a.wrap(function _callee5$(_context5) {
            while (1) {
              switch (_context5.prev = _context5.next) {
                case 0:
                  if (!(container.getElementsByClassName('therealsujitk-gifs-gif-column')[0].style.display === 'none')) {
                    _context5.next = 2;
                    break;
                  }
                    ...
                    return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_2___default.a.wrap(function _callee4$(_context4) {
                      while (1) {
                        switch (_context4.prev = _context4.next) {
                          case 0:
                            title = document.getElementById('therealsujitk-gifs-title');
      ...
      className: 'therealsujitk-gifs-favourite-column',
      style: 'display: none'
    }), flarum_common_components_LoadingIndicator__WEBPACK_IMPORTED_MODULE_5___default.a.component(), m('span', {
...
flarum_common_app__WEBPACK_IMPORTED_MODULE_1___default.a.initializers.add('therealsujitk/flarum-ext-gifs', function () {
  Object(flarum_common_extend__WEBPACK_IMPORTED_MODULE_0__["extend"])(flarum_common_components_TextEditor__WEBPACK_IMPORTED_MODULE_2___default.a.prototype, 'toolbarItems', function (items) {
    ...
    items.add('my-item', flarum_common_components_TextEditorButton__WEBPACK_IMPORTED_MODULE_3___default.a.component({
      id: 'therealsujitk-gifs-toolbar-item',
      title: flarum_common_app__WEBPACK_IMPORTED_MODULE_1___default.a.translator.trans('therealsujitk.forum.gifs.label'),
      className: 'Button Button--icon Button--link hasIcon',
      onclick: function onclick() {
        return flarum_common_app__WEBPACK_IMPORTED_MODULE_1___default.a.modal.show(_components_SearchGIFModal__WEBPACK_IMPORTED_MODULE_4__["default"], {
